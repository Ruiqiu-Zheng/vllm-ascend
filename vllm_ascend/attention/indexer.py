...
def compose_indexer_cache_metadata(
    ...
    *,
    ...
    including DSA-CP's TP-padded slots and PCP+DCP's PCP gather-order slots.
    Borrow only those addresses, leaving query ownership and per-forward
    sequence lengths to the existing path.
    """
