...
class AscendSFAImpl(MLAAttentionImpl):
    ...
    def _try_sfa_fia_shared_prefill(
        ...
        if len(query_lengths) > 1:
            ...
            plan = _build_sfa_multifia_prefill_plan(query_ends, kv_lengths)
            if plan is None:
                return None
            _, eligible_lengths, dense_segments, tail_spans, tail_query_ends, tail_kv_lengths, tail_requests = plan
